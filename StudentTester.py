...
def create_student():
    ...
    # Birthday
    birth_month = int(input("Enter birth month (Only Number, No Words): "))
    birth_day = int(input("Enter birth day: "))
    birth_year = int(input("Enter birth year: "))
    unified_birth_day = Date(birth_year, birth_month, birth_day)

    # Enrollment
    enrollment_month = int(input("Enter enrollment month (Only Number, No Words): "))
    ...
    # Semester
    starting_semester_month = int(input("Enter starting semester month (Only Number, No Words): "))
